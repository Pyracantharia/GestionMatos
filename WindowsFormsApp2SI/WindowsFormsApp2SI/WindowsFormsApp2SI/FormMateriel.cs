...
namespace WindowsFormsApp2SI
{
    public partial class FormMateriel : Form
    {
        ...
        private void buttonAjouter_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(textBoxNom.Text.Trim()))
            {
                MessageBox.Show("Veuillez saisir un nom pour le matériel.", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error);
                textBoxNom.Focus();
                return;
            }
            if (string.IsNullOrEmpty(textBoxSerie.Text.Trim()))
            {
                MessageBox.Show("Veuillez saisir un numéro de série pour le matériel.", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error);
                textBoxSerie.Focus();
                return;
            }
        ...
        private void textBoxSerie_TextChanged(object sender, EventArgs e)
        {
